...
const drawFive = () => {
  axios.get('http://localhost:4000/api/robots/five').then((res) => {
...
const duel = () => {
  ...
  setTimeout(() => {
    axios
      .post('http://localhost:4000/api/duel', { compDuo, playerDuo })
      .then(({ data }) => {
...
const getPlayerStats = () => {
  axios
    .get('http://localhost:4000/api/player')
...
const getAllBots = () => {
  axios.get('http://localhost:4000/api/robots').then(({ data }) => {
